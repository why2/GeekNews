...
public class Constants {
    ...
    public static final String KEY_API = "395652646e6880c6b124da29f40a32b8"; //需要APIKEY请去 http://www.tianapi.com/#wxnew 申请,复用会减少访问可用次数
    
    public static final String KEY_ALIPAY = "aex07566wvayrgxicnaraae";//支付宝key
